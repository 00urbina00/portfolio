...
export const profile = {
  ...
  role: {
    en: 'AWS Full Stack Developer at IBM',
    es: 'AWS Full Stack Developer en IBM',
  },
  ...
  cv: '/cv/Eduardo-Daniel-Urbina-Campos-CV.pdf',
};
...
export const copy = {
  en: {
    ...
    heroCopy: 'AWS Full Stack Developer at IBM, Computer Engineer and hands-on systems builder. I turn product ideas into secure applications, automated delivery pipelines and infrastructure I can operate end to end.',
    ...
    aboutP1: 'I am a licensed Computer Engineer based in Guadalajara and currently work at IBM as an AWS Full Stack Developer. My work sits at the intersection of application engineering, cloud and operational reliability.',
    ...
    journeyTitle: 'Growing from cloud intern to application developer at IBM.',
  ...
  es: {
    ...
    heroCopy: 'AWS Full Stack Developer en IBM, Ingeniero en Computación y constructor práctico de sistemas. Convierto ideas de producto en aplicaciones seguras, pipelines automatizados e infraestructura que puedo operar de principio a fin.',
    ...
    aboutP1: 'Soy Ingeniero en Computación titulado y con cédula profesional, radicado en Guadalajara, y actualmente trabajo en IBM como AWS Full Stack Developer. Mi trabajo vive en la intersección de aplicaciones, nube y confiabilidad operativa.',
    ...
    journeyTitle: 'Crecimiento de practicante cloud a application developer en IBM.',
